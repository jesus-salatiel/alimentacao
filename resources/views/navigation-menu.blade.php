            ...
            <div class="flex">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                    ...
                    <x-jet-nav-link href="{{ route('admin.produtos.create') }}" :active="request()->routeIs('dashboard')">
                        {{ __('Inserção de Produtos ') }}
                    </x-jet-nav-link>
                        @else
                        <x-jet-nav-link href="{{ route('escolas.produtos.create') }}" :active="request()->routeIs('dashboard')">
                        {{ __('Inserção de Produtos ') }}
                    </x-jet-nav-link>
                    @endcan

                    @can('admin-acess')
                    <x-jet-nav-link href="{{ route('admin.produtos.index') }}" :active="request()->routeIs('dashboard')">
                        {{ __('Listagem de Produtos') }}
                    </x-jet-nav-link>
                        @else
                        <x-jet-nav-link href="{{ route('escolas.produtos.index') }}" :active="request()->routeIs('dashboard')">
                        {{ __('Listagem de Produtos') }}
                    </x-jet-nav-link>
                    @endcan
